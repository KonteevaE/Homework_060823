...
Процедура ПриСозданииНаСервере(Форма, ПараметрыРазмещения = Неопределено) Экспорт
	...
	// Контеева Е., Нетология, 12.06.2023, добавление в форму документов реквизита Контактное лицо (контрагента),
	// обращение к созданному общему модулю {
	
	ЕК_РаботаСФормами.ДополнитьФорму(Форма);	
